...
def test_empty_series_yields_zero_corrections():
    # Arrange
    values = np.empty(0)
...
def test_series_entirely_inside_deadband_yields_zero_corrections():
    # Arrange
...
def test_series_exactly_at_deadband_boundary_is_treated_as_neutral():
    # Arrange
...
def test_constant_deflection_without_return_counts_as_single_correction():
    # Arrange
...
def test_single_excursion_and_return_counts_as_single_correction():
    # Arrange
...
def test_ideal_sine_yields_two_deadband_exits_per_period(frequency_hz, expected):
    # Arrange
...
def test_sine_smaller_than_deadband_yields_no_corrections():
    # Arrange
...
def test_zero_duration_yields_zero_instead_of_division_error():
    # Arrange
...
def test_correction_counted_only_on_outward_crossing_not_on_every_sample():
    # Arrange
